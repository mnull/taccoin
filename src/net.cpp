...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "taccoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"taccointools.com", "dnsseed.taccointools.com"},
    {"taccoinpool.org", "dnsseed.taccoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"taccointools.com", "testnet-seed.taccointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. taccoin is probably already running."), addrBind.ToString().c_str());
        else
